...
public final class PlotVolumeCLI extends Application {
    ...
    public final void start(final Stage primaryStage)
        ...
        /* Y 軸を作成 */
        final double ampBounds = Optional.ofNullable(cmd.getOptionValue("amp-bounds")).map(Double::parseDouble).orElse(Le4MusicUtils.waveformAmplitudeBounds);
        final double max_amp = 20 *  Math.log10(+ampBounds);
        final NumberAxis yAxis = new NumberAxis(/* axisLabel = */ "Volume (dB)", /* lowerBound = */ 0.0,
                /* upperBound = */ max_amp, /* tickUnit = */ Le4MusicUtils.autoTickUnit(ampBounds));
